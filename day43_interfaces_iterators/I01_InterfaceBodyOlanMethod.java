package JAVA_Summer_2022.day43_interfaces_iterators;
...
public interface I01_InterfaceBodyOlanMethod {
    ...
    public default void teker(){
        System.out.println("tum arabalarin tekeri vardir");//default keyword kullanilirsa, method'a erismek icin obje olusturulmalidir.
    }

    public static void direksiyon(){
        System.out.println("Tum arabalarin direksiyonu vardir");//burada static kelimesi kullanıldıgı icin diger child class dan bu method'a erismek icin
        //InterfaceAdi.methodAdi yeterli olur
    }
}
