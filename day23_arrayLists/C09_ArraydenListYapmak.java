...
public class C09_ArraydenListYapmak {
    ...
    System.out.println("arrayde degisiklik yapinca liste donusturen java metodu ile sayilar2 : " + sayilar2);

        System.out.println("arrayde degisiklik yapinca for loop ile yapilan  sayilar : " + sayilar);
}
}
